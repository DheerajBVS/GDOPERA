 ...
 *         &lt;element name="Activity" type="{http://webservices.micros.com/og/4.3/Activity/}BookedActivity" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "FetchActivityResponse")
public class FetchActivityResponse {

    @XmlElement(name = "Result", required = true)
    protected ResultStatus result;
    @XmlElement(name = "Activity")
    protected List<BookedActivity> activity;
     ...
     * 
     */
    public List<BookedActivity> getActivity() {
        if (activity == null) {
            activity = new ArrayList<BookedActivity>();
        }
