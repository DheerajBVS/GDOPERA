...
@XmlSeeAlso({
    ...
    ReservationTrace.class,
    SpecialRequest.class
})
public class Paragraph {

    @XmlElementRefs({
        @XmlElementRef(name = "URL", namespace = "http://webservices.micros.com/og/4.3/HotelCommon/", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Text", namespace = "http://webservices.micros.com/og/4.3/HotelCommon/", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Image", namespace = "http://webservices.micros.com/og/4.3/HotelCommon/", type = JAXBElement.class, required = false)
    })
