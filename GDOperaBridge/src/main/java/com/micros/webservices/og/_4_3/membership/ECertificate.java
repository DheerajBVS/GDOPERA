 ...
 *         &lt;element name="HotelReferences" type="{http://webservices.micros.com/og/4.3/HotelCommon/}HotelReference" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ECertificate {
    ...
    protected List<HotelReference> hotelReferences;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hotelReferences property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHotelReferences().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<HotelReference> getHotelReferences() {
        if (hotelReferences == null) {
            hotelReferences = new ArrayList<HotelReference>();
        }
        return this.hotelReferences;
    }
